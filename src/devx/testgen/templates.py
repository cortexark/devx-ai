...
Templates use ``string.Template`` with ``$placeholder`` syntax to avoid
conflicts with Python braces in generated test code.
"""
...
class TestTemplate:
    ...
    def render(self, context: dict[str, Any]) -> str:
        ...
        Uses ``string.Template`` for safe substitution that won't
        conflict with Python braces in generated code.
        ...
        """
        return string.Template(self.template).safe_substitute(context)
        ...
        self.register(
            TestTemplate(
                ...
                template=(
                    ...
                    '    """Test ${func_name} returns expected result for valid input."""\n'
                    "    # Arrange\n"
                    "    ${arrange}\n"
                    "\n"
                    "    # Act\n"
